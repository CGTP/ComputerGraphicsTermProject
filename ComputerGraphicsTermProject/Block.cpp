...
GLuint block_Nomal_object[6];
GLuint block_Tree_object[6];
GLubyte * LoadDIBitmap(const char *filename, BITMAPINFO **info);

void Nomal_Texture();//텍스쳐 적용부분
void Tree_Texture();
...
GLvoid drawScene(GLvoid){
	...
	drawBoxFront(90, false, block_Nomal_object[0]);
	drawBoxBack(90, false, block_Nomal_object[1]);
	drawBoxLeft(90, false, block_Nomal_object[2]);
	drawBoxRight(90, false, block_Nomal_object[3]);
	drawBoxTop(90, false, block_Nomal_object[4]);
	drawBoxBottom(90, false, block_Nomal_object[5]);
	glPopMatrix();

	glPushMatrix(); //Save 머리
	glTranslated(100, 0, 0);
	drawBoxFront(90, false, block_Tree_object[0]);
	drawBoxBack(90, false, block_Tree_object[1]);
	drawBoxLeft(90, false, block_Tree_object[2]);
	drawBoxRight(90, false, block_Tree_object[3]);
	drawBoxTop(90, false, block_Tree_object[4]);
	drawBoxBottom(90, false, block_Tree_object[5]);
	glPopMatrix();
...
void Nomal_Texture(){
	glGenTextures(6, block_Nomal_object);
	// 정면
	glBindTexture(GL_TEXTURE_2D, block_Nomal_object[0]);
	pBytes = LoadDIBitmap("ImageData/Block/Nomal/Around.bmp", &info);
	parameteri_Texture(256, 256);

	// 후면
	glBindTexture(GL_TEXTURE_2D, block_Nomal_object[1]);
	pBytes = LoadDIBitmap("ImageData/Block/Nomal/Around.bmp", &info);
	parameteri_Texture(256, 256);

	//왼쪽
	glBindTexture(GL_TEXTURE_2D, block_Nomal_object[2]);
	pBytes = LoadDIBitmap("ImageData/Block/Nomal/Around.bmp", &info);
	parameteri_Texture(256, 256);

	//오른쪽
	glBindTexture(GL_TEXTURE_2D, block_Nomal_object[3]);
	pBytes = LoadDIBitmap("ImageData/Block/Nomal/Around.bmp", &info);
	parameteri_Texture(256, 256);

	//위
	glBindTexture(GL_TEXTURE_2D, block_Nomal_object[4]);
	pBytes = LoadDIBitmap("ImageData/Block/Nomal/Top.bmp", &info);
	parameteri_Texture(256, 256);

	//아래
	glBindTexture(GL_TEXTURE_2D, block_Nomal_object[5]);
...
void Tree_Texture(){
	glGenTextures(6, block_Tree_object);
	// 정면
	glBindTexture(GL_TEXTURE_2D, block_Tree_object[0]);
	pBytes = LoadDIBitmap("ImageData/Block/Tree/Around.bmp", &info);
	parameteri_Texture(256, 256);

	// 후면
	glBindTexture(GL_TEXTURE_2D, block_Tree_object[1]);
	pBytes = LoadDIBitmap("ImageData/Block/Tree/Around.bmp", &info);
	parameteri_Texture(256, 256);

	//왼쪽
	glBindTexture(GL_TEXTURE_2D, block_Tree_object[2]);
	pBytes = LoadDIBitmap("ImageData/Block/Tree/Around.bmp", &info);
	parameteri_Texture(256, 256);

	//오른쪽
	glBindTexture(GL_TEXTURE_2D, block_Tree_object[3]);
	pBytes = LoadDIBitmap("ImageData/Block/Tree/Around.bmp", &info);
	parameteri_Texture(256, 256);

	//위
	glBindTexture(GL_TEXTURE_2D, block_Tree_object[4]);
	pBytes = LoadDIBitmap("ImageData/Block/Tree/Top.bmp", &info);
	parameteri_Texture(256, 256);

	//아래
	glBindTexture(GL_TEXTURE_2D, block_Tree_object[5]);
